...
const Hero = () => {
  ...
  return (
    <div ref={ref} className="w-full h-screen pt-40  bg-white rouded-br-[100px]">
          ...
          <div className="flex flex-col items-center justify-center md:flex-1 md:items-start ">
            ...
            >
              <h1
                ...
                data-scroll-speed="4"
                className="md:pt-20 pt-96 text-4xl md:text-6xl tracking-wider md:tracking-normal text-center text-gray-700 pl-20"
              >
                The Innovators
                <br />
                Inventing Global Solution
                <br />
              </h1>
            </motion.div>
            ...
            <div className="pt-10 pl-44">
              <button className="flex items-center bg-[#234F1E] rounded-xl justify-center p-4 text-white gap-4 text-xl hover:scale-110 transition-all ease-out">
                Learn More <TbArrowWaveRightUp size={30} />
              </button>
            </div>
          </div>
          <div className="hidden md:flex-1 md:inline-block pl-96">
            <div className="px-20 py-20">
               <Image
                src="/assets/thinktank.jpeg"
                width="408"
                height="580"
                alt="THINK TANK"
